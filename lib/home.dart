...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme:
          ThemeData(scaffoldBackgroundColor: const Color.fromARGB(255, 69, 44, 44)),
            ...
            MouseRegion(
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (_) => const JobListPage()), // ✅ ke loker.dart
                  );
                },
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: _isHovered
                        ? const Color(0xFF00695C) // warna muda saat hover
          ...
          children: [
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: const [
                  Text("Beasiswa Alumni Polines Peduli (Need-Based)",
                      style:
